...
module.exports = {
  ...
  updateNerdCoolScores: (guildId, userId) => {
    const nerdPower = globalThis.stats[guildId][userId].level < 15 ? 2.8 : 1.8;
    globalThis.stats[guildId][userId].nerdScore =
      Object.values(globalThis.stats[guildId][userId].nerdEmojis).reduce(
    ...
    globalThis.stats[guildId][userId].coolScore =
      Object.values(globalThis.stats[guildId][userId].coolEmojis).reduce(
  ...
  updateScoreValue: (guildId, userId) => {
    ...
    globalThis.stats[guildId][userId].levelExperience = Math.max(exp, 0);
  },
