...
module.exports = {
  ...
  execute(interaction) {
    ...
    if (globalThis.stats[guildId][userId].lastDailyTime > module.exports.getLastMidnightUnix()) {
    ...
    return interaction.reply(`You have received ${statsConfig.dailyTokens} tokens!`);
  },
  getLastMidnightUnix: () => moment()
    .subtract(1,"days")
    .startOf("day")
    .toString()
    .unix()
